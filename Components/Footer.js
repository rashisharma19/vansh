...
const Footer = () => {
  return (
    <div>
      <footer class="footer-1 bg-black py-8 sm:py-12">
        <div class="container mx-auto px-4">
          <div class="sm:flex sm:flex-wrap sm:-mx-4 md:py-4 pl-12">
          ...
          <div class="sm:flex sm:flex-wrap sm:-mx-4 mt-6 pt-6 sm:mt-12 sm:pt-12 border-t pl-12">
            ...
            <div style={{ textAlign: "center" ,marginTop:"2rem"}}>
              Copyright © FitPlus Wellness Private Limited
            </div>
        </div>
      </footer>
    </div>
